...
const Interview = () => {
    ...
    const { report, setReport, getReportById, getResumePdf, resumeLoading } = useInterview()
    ...
    const handleResumeDownload = async () => {
        try {
            ...
            toast.success(
                "Target resume generated successfully!"
            );

        } catch (error) {

            console.error("Target resume generation failed:", error);
            ...
            if (status === 503) {
                ...
                toast.error(
                    message ||
                    "Unable to generate target resume. Please try again."
                );
            }
        }
    };
                ...
                <div className='interview-layout'>
                    ...
                    <nav className='interview-nav'>
                        ...
                        <button
                            ...
                            className={`button resume-download-btn ${resumeLoading ? "resume-download-btn--loading" : ""}`}
                        ...
                        >
                            {resumeLoading ? (
                                ...
                                <>
                                    ...
                                    <span>Generate Target Resume</span>
                                </>
                            )}
                        </button>
                    </nav>
